...
public class TransactionReservesContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        squery.setTables(TransactionDBOpeHelper.TRANSACTION_RESERVES_TABLE);
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        long id = database.insert(TransactionDBOpeHelper.TRANSACTION_RESERVES_TABLE,null,values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch(uM.match(uri)){
            case ONEROW:
                ...
                count = database.delete(TransactionDBOpeHelper.TRANSACTION_RESERVES_TABLE,where,selectionArgs);
                break;
            case ALLROWS:
                count = database.delete(TransactionDBOpeHelper.TRANSACTION_RESERVES_TABLE,selection,selectionArgs);
            default: break;
        }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch(uM.match(uri)){
            case ONEROW:
                ...
                break;
            case ALLROWS:
                count = database.update(TransactionDBOpeHelper.TRANSACTION_RESERVES_TABLE,values,selection,selectionArgs);
            default: break;
        }
